<div class="checklistsQuestionarios index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Checklists Questionarios'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row row-offcanvas row-offcanvas-left">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Checklists Questionario'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9 table-responsive pre-scrollable">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($checklistsQuestionarios as $checklistsQuestionario): ?>
					<tr>
						<td><?php echo h($checklistsQuestionario['ChecklistsQuestionario']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($checklistsQuestionario['Nucleo']['id'], array('controller' => 'nucleos', 'action' => 'view', $checklistsQuestionario['Nucleo']['id'])); ?>
						...
						<td><?php echo h($checklistsQuestionario['ChecklistsQuestionario']['resultado']); ?>&nbsp;</td>
						<td><?php echo h($checklistsQuestionario['ChecklistsQuestionario']['created']); ?>&nbsp;</td>
						<td><?php echo h($checklistsQuestionario['ChecklistsQuestionario']['modified']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $checklistsQuestionario['ChecklistsQuestionario']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $checklistsQuestionario['ChecklistsQuestionario']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $checklistsQuestionario['ChecklistsQuestionario']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $checklistsQuestionario['ChecklistsQuestionario']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
