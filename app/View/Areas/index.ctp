	...
	<div class="row row-offcanvas row-offcanvas-left">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Area'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9 table-responsive pre-scrollable">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($areas as $area): ?>
					<tr>
						...
						<td><?php echo h($area['Area']['ordem']); ?>&nbsp;</td>
						<td><?php echo h($area['Area']['sigla']); ?>&nbsp;</td>
			...
			<?php echo $this->Html->link($area['Nucleo']['id'], array('controller' => 'nucleos', 'action' => 'view', $area['Nucleo']['id'])); ?>
						...
						<td><?php echo h($area['Area']['usuario']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $area['Area']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $area['Area']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $area['Area']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $area['Area']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
